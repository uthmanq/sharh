...
async function handleGoogleOAuth() {
    ...
    try {
        ...
        if (response.success) {
            ...
            // Provide a more descriptive fallback message
            const errorMessage = response.error || 'Authentication failed. Please try again or contact support if the issue persists.';
